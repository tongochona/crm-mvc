...
<body>
	<div class="bg-secondary bg-gradient">
		<div class="d-flex justify-content-between align-items-center p-3">
			<h1 class="pt-3 mb-0">CRM - Customers List</h1>
			<div>
				<a class="btn btn-success btn-lg me-2" href="admin/user/list">User List</a> 
	...
	<div class="container mt-5">
		<c:choose>
			<c:when test="${customers.size() > 0}">
				<form class="form-container d-flex mb-5" action="customer/search"
					method="GET">
				...
				<table class="table table-striped">
					<thead>
						<tr>
							<th scope="col"><a
								href="customer/list?sortBy=${SortUtils.SortByFirstName.value}">First
									Name</a></th>
							<th scope="col"><a
								href="customer/list?sortBy=${SortUtils.SortByLastName.value}">Last
									Name</a></th>
							<th scope="col"><a
								href="customer/list?sortBy=${SortUtils.SortByEmail.value}">Email</a></th>
					...
					<tbody>
						<c:forEach var="customer" items="${customers}">
							<tr>
								...
								<td><a href="customer/update?id=${customer.id}">Update</a>
									| <a class="delete" href="customer/delete?id=${customer.id}"
